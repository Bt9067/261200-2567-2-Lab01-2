...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] args) {
        ...
        // ตั้งค่าพื้นฐาน
        bob.width(2);      // กำหนดความหนาของเส้น
        bob.speed(100);    // เพิ่มความเร็วเพื่อวาดเร็วขึ้น

        // วาดพลุ
        for (int i = 0; i < 36; i++) { // หมุน 36 ทิศทาง (360 องศา / 10 องศา)
            bob.penColor(randomColor()); // เปลี่ยนสีแบบสุ่ม
            bob.forward(100);   // วาดเส้นออกไปด้านนอก
            bob.backward(100);  // กลับมาจุดศูนย์กลาง
            bob.right(10);      // หมุนขวา 10 องศา
        }
    ...
    public static String randomColor() {
        ...
        int randomIndex = (int) (Math.random() * colors.length); // สุ่มเลือกสี
